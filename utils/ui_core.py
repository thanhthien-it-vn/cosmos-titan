...
def apply_cosmos_style():
    """
    Hàm này chứa toàn bộ CSS của hệ thống COSMOS-TITAN.
    Mục đích: Tách biệt phần 'Da thịt' (Giao diện) ra khỏi phần 'Xương sống' (Logic).
    """
    st.markdown("""
        <style>
...
def header_component():
    """Hiển thị Header chuẩn của TITAN"""
